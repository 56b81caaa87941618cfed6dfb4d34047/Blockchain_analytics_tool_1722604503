...
*/
Vue.component("simple_footer_component_1722604507", {
    template: `
    <footer id="footer-section" class="flex-1 bg-gradient-to-r from-pink-400 to-purple-600 bg-opacity-50 backdrop-filter backdrop-blur-lg">
            <div id="footer-container" class="max-w-screen-xl p-8 py-10 mx-auto lg:py-16 md:p-12 lg:p-14 rounded-lg shadow-lg">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-lg text-center text-white opacity-80 hover:opacity-100 transition-opacity duration-300">
                        Stay ahead of the curve with our cutting-edge blockchain data analysis tools. Subscribe for updates on new features and industry insights.
                    </div>
                </div>
            </div>
        </footer> 
